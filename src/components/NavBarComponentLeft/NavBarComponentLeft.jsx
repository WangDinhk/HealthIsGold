...
import { Collapse, Checkbox, theme, Radio } from "antd";
...
// Định nghĩa nội dung cho các panel trong Collapse
    ...
    children: (
      <div style={{ display: "flex", flexDirection: "column", gap: "8px" }}>
        ...
        >
          ...
          <RadioButton value="100-300">100.000đ đến 300.000đ</RadioButton>
...
const NavBarComponentLeft = () => {
  ...
  // Kiểu cho các panel trong Collapse
  const panelStyle = {
    marginBottom: 24,
  ...
  // Hàm callback cho sự kiện thay đổi giá trị checkbox
  const onChange = (checkedValues) => {
    console.log("Checked values:", checkedValues);
  };

  // State lưu trữ key của các panel đang mở
  ...
  // Hàm xử lý khi nhấn vào từng panel
